...
Gatekeep uses crate versions for API expectations. Gatekeep 3.0 makes tenant
binding and durable audit provenance explicit; semver applies to the public
...
version. Gatekeep 3.0 requires Dovecote 0.2 for durable audit and Keepsake 3
...
reconciliation only. They are not the 3.0 runtime schema and must remain
byte-identical. Dovecote migrations define the required 3.0 event and delivery
